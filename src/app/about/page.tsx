    ...
    <div className="flex flex-col items-center justify-center py-6 max-sm:px-6 px-20">
      <div>
        <p className="text-gray-600 text-lg">
          ...
          Це може бути оголошення з категорії "надаю послугу" або "пропоную
          роботу". Ви зможете створити не більше двох оголошень за поточний
          місяць. Все це безкоштовно.
        </p>
      </div>
    </div>
  );
